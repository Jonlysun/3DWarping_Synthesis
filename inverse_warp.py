...
def inverse_warp(img, depth, pose1, intrinsics, rotation_mode='euler', padding_mode='zeros'):
    """
    ...
    img = F.grid_sample(img, src_pixel_coords.type(torch.cuda.FloatTensor), padding_mode=padding_mode)
    return img
